...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/png" href="<c:url value="/resources/img/brand/favicon.png"/>">
 <!-- Fonts -->
  <link rel="stylesheet" href="<c:url value="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700"/>">
  <!-- Icons -->
  <link rel="stylesheet" href="<c:url value="/resources/vendor/nucleo/css/nucleo.css"/>">
  <link rel="stylesheet" href="<c:url value="/resources/vendor/@fortawesome/fontawesome-free/css/all.min.css"/>">
  <!-- CSS -->
  <link rel="stylesheet" href="<c:url value="/resources/css/argon.css"/>">
</head>
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../examples/icons.html">
              <i class="ni ni-planet text-blue"></i> Menambahkan Transaksi
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../examples/maps.html">
              <i class="ni ni-pin-3 text-orange"></i> Riwayat Transaksi
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../examples/tables.html">
              <i class="ni ni-bullet-list-67 text-red"></i> Pembukuan
            </a>
          </li>
          <li class="nav-item">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">Hello PBKK A</h1>
          ...
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
                ...
                <div class="col">
                  <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                    ...
                    <div>
                      ...
                      <span class="description">Franchise</span>
                    </div>
                    <div>
              ...
              <div class="text-center">
                ...
                <div class="h5 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>CEO Crypto Valley
                </div>
                <div>
                  <i class="ni education_hat mr-2"></i>Sepuluh Nopember Institute of Technology
                </div>
                <hr class="my-4" />
                <p>Crypto Valley - One of the World's Leading Distributed Ledger and Blockchain Ecosystems.</p>
                <a href="#">Show more</a>
              </div>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control form-control-alternative" placeholder="Home Address" value="Perumdos Blok U Teknik Komputer 5 no 182" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" class="form-control form-control-alternative" placeholder="City" value="Surabaya">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="input-postal-code" class="form-control form-control-alternative" placeholder="611112">
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="row align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-center text-xl-left text-muted">
              &copy; 2019 <a href="https://www.creative-tim.com" class="font-weight-bold ml-1" target="_blank">E-COUNTANT</a>
            </div>
          </div>
        </div>
      </footer>
